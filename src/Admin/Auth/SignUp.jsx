        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-lg  bg-white h-full text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <main className="relative flex h-full gap-3 flex-row">
                    <section className="relative bg-blue-500 text-white p-5 w-2/3 ">
                      <h1>SignUp</h1>
                      <h1>
                      To get access to your products and orders.
                      </h1>
                    ...
                    <section className="mt-3 py-4 flex flex-col gap-3 w-full">
