...
const EditProduct = () => {
  ...
  useEffect(() => {
    if (product) {
      ...
      // console.log("database",product.image);
      const imageUrls = product.image.map((i) => i.url || i);
      setImage(imageUrls);
      setBrandName(product.brand?.Name);
      setBrandLogo(product.brand?.logo.url);
      setHighlights(product.Highlights);
      setServices(product.service);
          ...
          >
            <div className="flex flex-col gap-3 m-2 sm:w-1/2">
              ...
              <TextField
                ...
                // required
                value={services[0]}
                onChange={(e) => services(e.target.value)}
              />
